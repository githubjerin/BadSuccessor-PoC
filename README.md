...
![](https://github.com/githubjerin/BadSuccessor-PoC/assets/1.png)
- Next we need to use Rubeus:
    ...
    ![](https://github.com/githubjerin/BadSuccessor-PoC/assets/2.png)
    ...
    ![](https://github.com/githubjerin/BadSuccessor-PoC/assets/3.png)
    ...
    ![](https://github.com/githubjerin/BadSuccessor-PoC/assets/4.png)
-Convert the ticket obtained from the previous step to a .ccache file using any base64 to ccache converter.
![](https://github.com/githubjerin/BadSuccessor-PoC/assets/5.png)
...
![](https://github.com/githubjerin/BadSuccessor-PoC/assets/6.png)
